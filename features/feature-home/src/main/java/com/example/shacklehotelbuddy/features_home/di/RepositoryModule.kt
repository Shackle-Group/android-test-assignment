...
object RepositoryModule {
    ...
    fun providePropertyRepository(
        propertiesApi: PropertiesApi, searchQueryDao: SearchQueryDao, appDispatchers: AppDispatchers
    ): PropertyRepository = PropertyRepositoryImpl(propertiesApi, searchQueryDao, appDispatchers)
